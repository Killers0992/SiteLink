...
public class DecontaminationManagerObject : NetworkObject
{
    ...
    public override uint NetworkId { get; set; } = 437;
    ...
    public DecontaminationManagerObject(World world, Session owner = null, uint networkId = 0) : base(world, owner, networkId)
    {
        //
